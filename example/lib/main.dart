      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text('Form Definition (JSON)', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
              ),
              IconButton(
          ...
          Card(
            child: Padding(
              padding: const EdgeInsets.all(16),
              child: SelectableText(formJson, style: const TextStyle(fontFamily: 'monospace', fontSize: 12)),
            ),
          ),
          const SizedBox(height: 16),
          if (formData.isNotEmpty) ...[
            Row(
              children: [
                Expanded(
                  child: Text('Current Form Data', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
                ),
                IconButton(
                  icon: const Icon(Icons.copy),
                  ...
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Form data copied to clipboard'),
                        duration: Duration(seconds: 2),
                      ),
                    );
                  },
            ...
            Card(
              ...
              child: Padding(
                padding: const EdgeInsets.all(16),
                child: SelectableText(dataJson, style: const TextStyle(fontFamily: 'monospace', fontSize: 12)),
              ),
            ),
          ],
        ],
